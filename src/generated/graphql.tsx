...
export type AllMissionsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllMissionsQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_id' | 'flight_number' | 'mission_name'>
  )>>> }
);
...
export type MissionInfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'mission_id' | 'details' | 'launch_date_local' | 'upcoming' | 'launch_success' | 'launch_year'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
...
export type UpcomingLaunchesListQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'mission_id' | 'upcoming' | 'launch_year'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'wikipedia' | 'flickr_images'>
    )> }
  )>>> }
);


export const AllMissionsDocument = gql`
    query allMissions {
  launches {
    mission_id
    flight_number
...
/**
 * __useAllMissionsQuery__
 *
 * To run a query within a React component, call `useAllMissionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllMissionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllMissionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllMissionsQuery(baseOptions?: Apollo.QueryHookOptions<AllMissionsQuery, AllMissionsQueryVariables>) {
        return Apollo.useQuery<AllMissionsQuery, AllMissionsQueryVariables>(AllMissionsDocument, baseOptions);
      }
export function useAllMissionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllMissionsQuery, AllMissionsQueryVariables>) {
          return Apollo.useLazyQuery<AllMissionsQuery, AllMissionsQueryVariables>(AllMissionsDocument, baseOptions);
        }
export type AllMissionsQueryHookResult = ReturnType<typeof useAllMissionsQuery>;
export type AllMissionsLazyQueryHookResult = ReturnType<typeof useAllMissionsLazyQuery>;
export type AllMissionsQueryResult = Apollo.QueryResult<AllMissionsQuery, AllMissionsQueryVariables>;
...
export function useUpcomingLaunchesListQuery(baseOptions?: Apollo.QueryHookOptions<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>) {
        return Apollo.useQuery<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>(UpcomingLaunchesListDocument, baseOptions);
      }
export function useUpcomingLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>) {
          return Apollo.useLazyQuery<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>(UpcomingLaunchesListDocument, baseOptions);
        }
